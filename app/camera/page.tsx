  ...
  return (
    <div className="tape" aria-hidden>
      <div className="tape-track">
        <span><b>● LIVE</b> &nbsp; WEB-CAM SCAN ACTIVE</span>
        <span>YOLO-V8 · REAL-TIME</span>
        <span>SHEET C-01 / EVALUATION</span>
        <span><b>►</b> SCANNING LAYOUT</span>
  ...
  return (
    <footer className="foot">
      <div className="foot-inner">
        ...
        <div className="mid">Sheet C-01 · Live Camera Evaluation</div>
